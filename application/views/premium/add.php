...
<head>
	...
	<title>Tambah Harga Premium</title>
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Tambah Harga Premium</span>
						<h3 class="page-title">Tambah Harga Premium</h3>
...
<script src="http://terawang.co/admin/js/add_premium.js"></script>
