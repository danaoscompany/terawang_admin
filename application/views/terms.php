...
<head>
	...
	<title>Kebijakan Penggunaan</title>
...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'terms')); ?>
		</aside>
		<!-- End Main Sidebar -->
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Kebijakan Penggunaan</span>
						<h3 class="page-title">Kebijakan Penggunaan</h3>
						...
						<div class="card card-small mb-3">
							<div class="card-body">
								<form class="add-new-post">
									<h6 class="m-0">Kebijakan Penggunaan (Bahasa Indonesia)</h6>
									<div style="height: 4px;"></div>
									<div id="terms-in" class="add-new-post__editor mb-1"></div>
								</form>
								<form class="add-new-post">
									<h6 class="m-0">Kebijakan Penggunaan (English)</h6>
									<div style="height: 4px;"></div>
									<div id="terms-en" class="add-new-post__editor mb-1"></div>
								</form>
								<form class="add-new-post">
									<h6 class="m-0">Kebijakan Penggunaan (Bahasa Cina)</h6>
									<div style="height: 4px;"></div>
									<div id="terms-zh" class="add-new-post__editor mb-1"></div>
								</form>
							</div>
						</div>
						<!-- / Add New Post Form -->
...
<script src="http://terawang.co/admin/js/terms.js"></script>
