...
<head>
	...
	<title>Tambah Rekening Donasi</title>
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Tambah Rekening Donasi</span>
						<h3 class="page-title">Tambah Rekening Donasi</h3>
...
<script src="http://terawang.co/admin/js/add_donation.js"></script>
