			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Ubah Quote</span>
						<h3 class="page-title">Ubah Quote</h3>
						...
						<div class="card card-small mb-3">
							<div class="card-body">
								<form class="add-new-post">
									<div class="form-row">
										<h6 class="m-0">Masukkan Quote</h6>
										...
										<div class="input-group mb-3" style="margin-top: 0;">
											<div class="input-group input-group-seamless">
												...
												<textarea id="quote-id" class="form-control" name="feDescription" placeholder="Quote Bahasa Indonesia" rows="5"></textarea>
											</div>
										</div>
										<div class="input-group mb-3" style="margin-top: 0;">
											<div class="input-group input-group-seamless">
												...
												<textarea id="quote-en" class="form-control" name="feDescription" placeholder="Quote English" rows="5"></textarea>
											</div>
										</div>
										<div class="input-group mb-3" style="margin-top: 0;">
											<div class="input-group input-group-seamless">
												...
												<textarea id="quote-zh" class="form-control" name="feDescription" placeholder="Quote Bahasa Cina" rows="5"></textarea>
											</div>
										</div>
									</div>
								</form>
...
<input id="edited-quote-id" type="hidden" value="<?php echo $quoteID; ?>">
...
<script src="http://terawang.co/admin/js/edit_quote.js"></script>
