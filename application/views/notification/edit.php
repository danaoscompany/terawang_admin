								...
								<form class="add-new-post">
									<div class="form-row">
										<div class="form-group col-md-12">
											<label for="feDescription">Masukkan Konten:</label>
...
<input id="notification-id" type="hidden" style="width: 0; height: 0; visibility: hidden;" value="<?php echo $notificationID; ?>">
</div>
...
<script src="http://terawang.co/admin/js/edit_notification.js"></script>
