			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Harga Premium</span>
						<h3 class="page-title">Harga Premium</h3>
					...
					<div class="col">
						<div style="width: 100%; display: flex; flex-direction: row; align-items: center; justify-content: flex-end;">
							<button type="button" class="mb-2 btn btn-sm btn-primary mr-1" style=""
									onclick="window.location.href='http://terawang.co/admin/premium/add'">Tambah</button>
						</div>
						<div class="card card-small mb-4" style="margin-top: 8px;">
							<div class="card-header border-bottom">
								<h6 class="m-0">Harga Premium</h6>
							</div>
