...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'privacy_policy')); ?>
		</aside>
		<!-- End Main Sidebar -->
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Kebijakan Privasi</span>
						<h3 class="page-title">Kebijakan Privasi</h3>
						...
						<div class="card card-small mb-3">
							<div class="card-body">
								<form class="add-new-post">
									<h6 class="m-0">Kebijakan Privasi (Bahasa Indonesia)</h6>
									<div style="height: 4px;"></div>
									<div id="privacy-policy-in" class="add-new-post__editor mb-1"></div>
								</form>
								<form class="add-new-post">
									<h6 class="m-0">Kebijakan Privasi (English)</h6>
									<div style="height: 4px;"></div>
									<div id="privacy-policy-en" class="add-new-post__editor mb-1"></div>
								</form>
								<form class="add-new-post">
									<h6 class="m-0">Kebijakan Privasi (Bahasa Cina)</h6>
									<div style="height: 4px;"></div>
									<div id="privacy-policy-zh" class="add-new-post__editor mb-1"></div>
								</form>
							</div>
						</div>
						<!-- / Add New Post Form -->
...
<script src="http://terawang.co/admin/js/privacy_policy.js"></script>
