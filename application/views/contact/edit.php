			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Ubah Kontak</span>
						<h3 class="page-title">Ubah Kontak</h3>
							...
							<div class="card-body">
								<form class="add-new-post">
									<div class="form-row">
										...
										<div class="m-0">Nomor/Alamat:</div>
										<div class="input-group mb-3">
											<div class="input-group input-group-seamless">
												<span class="input-group-prepend">
                              						<span class="input-group-text">
...
<input id="contact-id" style="width: 0; height: 0; visibility: hidden;" value="<?php echo $contactID; ?>">
...
<script src="http://terawang.co/admin/js/edit_contact.js"></script>
