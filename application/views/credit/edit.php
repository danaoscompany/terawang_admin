...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'credit')); ?>
		</aside>
		<!-- End Main Sidebar -->
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						<span class="text-uppercase page-subtitle">Tambah Harga Kredit</span>
						<h3 class="page-title">Tambah Harga Kredit</h3>
...
<input id="credit-id" type="hidden" value="<?php echo $creditID; ?>">
...
<script src="http://terawang.co/admin/js/edit_credit.js"></script>
