...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'city')); ?>
		</aside>
		<!-- End Main Sidebar -->
					...
					<div class="col">
						...
						<div class="card card-small mb-4" style="margin-top: 8px;">
							...
							<div class="card-body p-0 pb-3 text-center">
								...
								<div style="width: 100%; display: flex; justify-content: center; flex-direction: row; margin-top: 8px;">
									<button id="prev" type="button" class="mb-2 btn btn-sm btn-primary mr-1" style="margin-right: 8px;"
											onclick="goToPrevPage()">Sebelumnya</button>
									<button id="prev" type="button" class="mb-2 btn btn-sm btn-primary mr-1" style=""
											onclick="goToNextPage()">Berikutnya</button>
								</div>
							</div>
						</div>
					</div>
