...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'notification')); ?>
		</aside>
		<!-- End Main Sidebar -->
								...
								<form class="add-new-post">
									<div class="form-row">
										<div class="form-group col-md-12">
											<label for="feDescription">Pertanyaan:</label>
											<textarea id="question" class="form-control" name="question" rows="5"></textarea>
										</div>
										<div class="form-group col-md-12">
											<label for="feDescription">Masukkan jawaban:</label>
							...
							<div class='card-body p-0'>
								<ul class="list-group list-group-flush">
									<li class="list-group-item d-flex px-3">
										...
										<button class="btn btn-sm btn-accent ml-auto" onclick="answer()">
											<i class="material-icons">file_copy</i> Jawab</button>
									</li>
								</ul>
							</div>
						</div>
...
<input id="question-id" type="hidden" value="<?php echo $questionID; ?>">
...
<script src="http://terawang.co/admin/js/answer_question.js"></script>
