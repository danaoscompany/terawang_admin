...
<div class="container-fluid">
	<div class="row">
		...
		<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
			...
			<?php $this->load->view('sidebar', array('current_menu' => 'question')); ?>
		</aside>
		<!-- End Main Sidebar -->
							...
							<div class="card-body p-0 pb-3 text-center">
								<table class="table mb-0">
									...
									<tr>
										...
										<th scope="col" class="border-0">Pengirim</th>
										<th scope="col" class="border-0">Pertanyaan</th>
										<th scope="col" class="border-0">Dijawab</th>
										<th scope="col" class="border-0">Rating</th>
										<th scope="col" class="border-0">Tanggal</th>
										<th scope="col" class="border-0">Jawab</th>
